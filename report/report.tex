...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../results/plots/degree_distribution.png}
    \caption{Degree distribution of players highlighting the heavy-tailed right skew.}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../results/plots/community_win_rates.png}
    \caption{True Average Win Rate computed across the top 10 functional communities.}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{../results/plots/confusion_matrix.png}
    \caption{Confusion Matrix for the predictive power of the Random Forest model driven solely by relative graph topology.}
\end{figure}
